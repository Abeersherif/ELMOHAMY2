...
- إذا كانت المادة تحتوي على قوائم طويلة (قوانين ملغاة، بنود متعددة، شروط كثيرة)، **لخّصها** واذكر العدد الإجمالي وأبرز العناصر فقط. ضع التفاصيل في قسم "📎 مواضيع ذات صلة" في نهاية الإجابة.
