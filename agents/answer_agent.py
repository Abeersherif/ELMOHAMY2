...
(ثانياً) **⚖️ شرح المادة [رقم المادة] من [اسم القانون الصحيح بالكامل]**
...
- إذا كانت المادة تحتوي على قوائم طويلة (قوانين ملغاة، بنود متعددة، شروط كثيرة)، **لخّصها** واذكر العدد الإجمالي وأبرز العناصر فقط. مثلاً: "تلغي هذه المادة نحو 40 قانوناً سابقاً تتعلق بالزراعة والثروة الحيوانية." ثم ضع القائمة الكاملة في قسم "📎 مواضيع ذات صلة" في نهاية الإجابة.
...
(ثامناً) **📎 مواضيع ذات صلة** — يُكتب هذا القسم **فقط** إذا كانت المادة تحتوي على قوائم طويلة أو تفاصيل فرعية لم تُذكر في الشرح الرئيسي.
- اعرض العناصر المهمة على شكل نقاط مختصرة.
- هذا القسم اختياري — تجاوزه إذا لم تكن هناك تفاصيل إضافية.
